package com.jsidegum.alcoolougasolina
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        inicializarConponentesInterface()
    ...
    private fun inicializarConponentesInterface() {
    ...
    private fun calcularMelhorPreco() {
        ...
        if (resultadoValidacao) {
            ...
            if (resultado >= 0.7) {
                ...
                textResultado.text = "É melhor usar Alcool"
            }
        }
